 //------------------------------------------------------------------------------------------------
 class SCR_SetTargetDistanceDownUserAction : ScriptedUserAction
 {
...
         firingRangeNetworkEntity.CalculateTargetDistance(pOwnerEntity, false);
     }
     //------------------------------------------------------------------------------------------------
...
     {
         return m_LineController && !m_LineController.IsLowestDistanceSet();
     }

     //------------------------------------------------------------------------------------------------
     override bool GetActionNameScript(out string outName)
     {
         outName = ("#AR-FiringRange_ActionDistanceDown-UC");
         return true;
     }
