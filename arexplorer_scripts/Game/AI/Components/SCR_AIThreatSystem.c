...
 {
     private static const float THREAT_SHOT_DROP_RATE =  0.11 * 0.001;
...
     private static const float EXPLOSION_CLOSE_DISTANCE = 12;
     static const float EXPLOSION_MAX_DISTANCE = 700;
...
     private float m_fThreatIsEndangered;
