...
     protected static const float DISTANCE_HYSTERESIS_FACTOR = 0.45;
     protected static const float NEARBY_DISTANCE_SQ = 2500;
     protected static const float REACTION_TO_SAME_UNKNOWN_TARGET_INTERVAL_MS = 2500;
