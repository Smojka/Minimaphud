...
     // Perception factors
     protected const float PERCEPTION_FACTOR_SAFE = 1.0;
     protected const float PERCEPTION_FACTOR_VIGILANT = 2.5;
...
     protected bool m_bCurrentVehicleEvac;
     protected SCR_BaseCompartmentManagerComponent m_CurrentVehicleCompartmentManager;
     protected BaseCompartmentSlot m_CurrentCompartmentSlot;
     protected TurretControllerComponent m_CurrentTurretController;

     protected EAICombatActions  m_iAllowedActions;
...
     protected ref BaseTarget m_SelectedRetreatTarget;
     protected ref array<IEntity> m_aAssignedTargets = {};
     protected SCR_AITargetClusterState m_TargetClusterState;
     protected EAIUnitType m_eExpectedEnemyType = EAIUnitType.UnitType_Infantry;
     protected ResourceName m_SelectedWeaponResource;

     // Weapon selection against a specific target and its properties
     protected BaseWeaponComponent m_SelectedWeaponComp;
     protected BaseMagazineComponent m_SelectedMagazineComp;
...
     protected BaseCompartmentSlot m_WeaponEvaluationCompartment;
...
     protected static const float TURRET_TARGET_EXCESS_ANGLE_THRESHOLD_DEG = 3.0;
     protected const float DISMOUNT_TURRET_TIMER_MS = 1200;
     protected static ref array<EVehicleType> s_aForbidDismountTurretsOfVehicleTypes = { EVehicleType.APC };

     // Perception
     protected float m_fEquipmentPerceptionFactor = 1.0;
     protected float m_fPerceptionFactor = 1.0;

     protected EGadgetType m_eCurrentGadgetType = -1;
     protected bool m_bGadgetFocus = false;
