...
     //~ States
     protected bool m_bLocalEditorNightModeEnabled;
     protected bool m_bLocalEditorNightModeOnEditorClose;
     protected bool m_bUnlimitedEditorIsOpen;
     protected bool m_bGlobalNightModeEnabled;
     protected bool m_IsPreviewingTimeOrWeather;
     protected float m_fNightModeAlpha = 0;

     //~ Update
     protected bool m_bUpdateEachFrame;
     protected float m_fCurrentUpdateTickInSeconds;
     protected static const float UPDATE_TICK_IN_SECONDS = 1;
