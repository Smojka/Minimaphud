...
     protected ref array<ref SCR_Ray> m_aAnchorRays;
     protected ref array<ref SCR_Ray> m_aMidPointRays;
     protected ref array<ref SCR_Ray> m_aTesselatedPointRays;
...
     protected float m_fMinSlope, m_fMaxSlope;
