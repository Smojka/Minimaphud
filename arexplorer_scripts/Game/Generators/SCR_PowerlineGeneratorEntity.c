...
     [Attribute(defvalue: "1", desc: "Make the random pitch possible on both sides (-180..+180Â°) or, if disabled, one side only (0..180Â°)", category: "Randomisation")]
...
     [Attribute(defvalue: "1", desc: "Make the random roll possible on both sides (-180..+180Â°) or, if disabled, one side only (0..180Â°)", category: "Randomisation")]
